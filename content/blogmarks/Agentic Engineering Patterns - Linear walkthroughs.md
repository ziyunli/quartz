...
> Cross-references from studying [Linear Walkthroughs - Agentic Engineering Patterns](https://simonwillison.net/guides/agentic-engineering-patterns/linear-walkthroughs/#atom-everything) by Simon Willison. Added with Claude Opus 4.6 via Claude Code.
...
> - [How to Solve It with Code](https://solve.it.com/) — Jeremy Howard's "Solve It" method would push back on the vibe-code-then-learn sequence: Howard argues ==you should stay in contact with the code as you build it==, inspecting every output, because understanding compounds during construction, not after. The walkthrough closes the gap, but Howard would ask whether the gap should have existed at all.
>   ^related-reading
